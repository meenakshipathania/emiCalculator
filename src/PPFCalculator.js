  ...
  const Results = () => (
    <div id="results" className="search-results">
       <div className="socialshare"><ShareSocial
                    style={style}
                    url="http://www.psd2htmlx.com/react/allcalculator/index.html#/PPFCalculator"
      ...
      <div className="container mar">
        <div className="row">
          ...
          <div className="calculation">
            ...
            <h2 className="heading">PPF Calculator</h2>
            <div className="inner_container">
              <div className="half">
                ...
                <input type="range" min="500" step="500" id="invest1" value={value1 ? value1 : 1} max="200000" className="range" onChange={({ target: { value: radius } }) => {
                onChange1(radius);
              }}></input>
              <br />
              <br />
              ...
              <p className="labelPara">Yr</p>  
                ...
                <input type="range" min="1" id="invest3" value={value3 ? value3 : 0} max="30" step="1" className="range" onChange={({ target: { value: radius } }) => {
                onChange3(radius);
              }}></input>
              <br />
               <br />
